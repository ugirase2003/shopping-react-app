...
const Footer = () => {
  return (
    <div className='max-w-[1400px] mx-auto relative top-5   '>
           <div className='  mt-8 grid grid-cols-2 max-w-[600px]' >
           <Link to={''} className=''>
...
<Link className=''>
<div className='h-50 w-50 shadow-lg rounded-lg hover:scale-105 p-6 flex  items-center max-w-[300px] ml-4 bg-white '>
